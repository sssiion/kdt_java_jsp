...
<form method=post action="savedata.jsp">
    <table >
        ...
        <tr>
            <td>메일주소:</td>
            <td><input type="text" style="width: 60px;" id="email_pre" name="email_f"/> @ <input name="email_l" id="email_last" type="text" style="width: 80px;" readonly />
        ...
        <tr>
            <td>주민등록번호:</td>
            <td>
                <input name="hnumber_f" id="numberic_pre" type="text" maxlength="6" oninput="birthdayinput(this.value)"style="background-color:white;"> -</input> <input name="hnumber_l" id="numberic_last" type="password" maxlength="7" oninput="residentnumber(this.value)"></input>
        ...
        <tr>
            <td>주소: </td>
            <td ><div id="memberbox" >
                    <input name="addrnumber" id="member_post"  placeholder="우편번호" style="background-color:white;" readOnly ></input>
                    <div onclick="openZipcode()" id="addressbutton" >우편번호</div>
                </div>

                <input name="addr" id="member_addr" type="text" placeholder=지번 readonly ></input><br>
                <input id="totaladdress" type="text" placeholder=상세주소  ></input>
            </td>
        </tr>
        <tr>
            <td>자기소개:</td>
            <td><textarea  name="intro" id="textbox"  placeholder="20자이상 작성해주세요. "></textarea></td>
        </tr>
    </table>
	<div>
	    <input class="buttoncss" type="submit" value="회원가입"  />
	    <div></div>

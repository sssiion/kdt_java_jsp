...
function totalcheck(){
    ...
    if (!idpwcheck("Id", "Idmessage"))
        return;
    else if (!idpwcheck("pw", "Passwordmessage"))
        return;
    else if (!passwordcheck())
        return;
    else if(!nullchenk("fullname"))
        return;
    else if(!nullchenk("email_pre"))
        return;
    else if(!nullchenk("email_last"))
        return;
    else if(!nullchenk("numberic_pre"))
        return;
    else if(!nullchenk("numberic_last"))
        return;
    else if (!hobbycheck())
        return;
    else if (!nullchenk("member_addr"))
        return;
    else if(!textboxcheck())
        return;
